            ...
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-xl relative overflow-hidden max-h-[85vh] flex flex-col">
                ...
                <div className="px-8 pb-8 space-y-6 overflow-y-auto">
                    ...
                    <div className="space-y-2">
                        <label className="block text-sm font-medium text-gray-700">Please provide details of your request</label>
                        <textarea
                            className="w-full h-32 p-3 border border-gray-200 rounded-xl resize-none focus:ring-2 focus:ring-blue-500 outline-none text-sm placeholder:text-gray-400"
                    ...
                    <div className="flex justify-between items-center pt-2">
                        <p className="text-sm text-gray-500">Our team will get in touch shortly.</p>
                        <button className="bg-[#2563EB] text-white px-6 py-2.5 rounded-xl font-medium hover:bg-blue-700 transition-colors">
                            Send request
                        </button>
                    </div>
                </div>
