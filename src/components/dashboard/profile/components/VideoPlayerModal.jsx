...
const VideoPlayerModal = ({ isOpen, onClose, video }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fadeIn">
            <div className="bg-white w-full max-w-[800px] rounded-[20px] shadow-2xl overflow-hidden mx-4 flex flex-col max-h-[90vh]">
                ...
                <div className="p-4 flex items-center justify-end gap-3 bg-white border-t border-gray-100">
                    <button
                        onClick={onClose}
                        className="px-6 py-2 bg-[#F5F5F5] hover:bg-gray-200 text-[#787878] rounded-md text-sm font-semibold transition-colors"
                    >
                        Back
                    </button>
                    <button className="px-6 py-2 bg-[#1B7AF9] hover:bg-[#1565d8] text-white rounded-md text-sm font-semibold transition-colors">
                        Next Video
                    </button>
                </div>
            </div>
