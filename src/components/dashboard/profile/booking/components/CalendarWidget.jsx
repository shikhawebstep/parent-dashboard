    ...
    return (
        <div className="bg-white p-6 rounded-[20px] shadow-sm animate-fadeIn">
            <div className="flex items-center justify-center gap-4 mb-6">
                ...
                <button onClick={nextMonth} className="p-1 hover:bg-gray-100 rounded-full text-[#191919]">
            ...
            <div className="grid grid-cols-7 mb-4">
                {days.map((day) => (
                    <div key={day} className="text-center text-xs font-bold text-[#191919]">
                        {day}
                    </div>
                ))}
            </div>
                    ...
                    return (
                        <div key={idx} className="flex justify-center">
                            <button
                                ...
                                className={`w-8 h-8 flex items-center justify-center rounded-full text-xs transition-colors ${textColor} ${fontWeight} ${bgClass}`}
                            >
                                {format(day, 'd')}
                            </button>
                        </div>
