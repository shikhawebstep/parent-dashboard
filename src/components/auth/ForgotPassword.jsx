...
const ForgotPassword = () => {
  ...
  return (
    <div className="w-full h-screen  flex items-center p-5 lg:p-10 xl:p-0">
      <div className="w-full flex flex-col bg-white shadow-md max-w-[33%] 2xl:max-w-[25%] border border-gray-200 rounded-[20px] p-10 m-auto items-center justify-center  ">
        <div className="text-center w-full mb-8">
          ...
          <h2 className="2xl:text-[32px] text-[28px]  font-semibold mt-3">
            Forgot Password?
          </h2>
          ...
          <div className="my-5">
            ...
            <input
              ...
              className={`w-full mt-1 px-4 py-2.5 border ${
                errors.email ? "border-red-500" : "border-[#D0CFD1]"
