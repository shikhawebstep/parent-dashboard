    ...
    return (
        <div className="animate-fadeIn">
            ...
            <div className="flex flex-col xl:flex-row items-start gap-6">
                {/* Left Side: Forms */}
                <div className="flex-1 xl:w-[70%] space-y-8 p-6 pb-10 rounded-[30px] bg-white">

                    {/* Student Information */}
                    <section>
                        <h2 className="text-[24px] font-bold text-[#383A46] mb-4">Student information</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1">
                                <label className="text-[16px] font-medium text-[#282829] font-medium">First name</label>
                            ...
                            <div className="space-y-1">
                                <label className="text-[16px] font-medium text-[#282829] font-medium">Last name</label>
                                <div className="relative">
                                    <input
                                        type="text"
                    ...
                    {/* Booking Information */}
                    <section>
                        <h2 className="text-[24px] font-bold text-[#383A46] mb-4">Booking information</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1">
                                <label className="text-[16px] font-medium text-[#282829] font-medium">Start Date</label>
                            ...
                            <div className="space-y-1">
                                <label className="text-[16px] font-medium text-[#282829] font-medium">Venue</label>
                                <div className="relative">
                                    <select className="w-full p-3 border border-[#E2E1E5] rounded-[12px] focus:outline-none focus:border-[#042C89] bg-white text-[#383A46] font-medium appearance-none">
                            ...
                            <div className="space-y-1">
                                <label className="text-[16px] font-medium text-[#282829] font-medium">Class</label>
                                <div className="relative">
                                    <select className="w-full p-3 border border-[#E2E1E5] rounded-[12px] focus:outline-none focus:border-[#042C89] bg-white text-[#383A46] font-medium appearance-none">
                                        <option>4-7 years</option>
                                    </select>
                            ...
                            <div className="space-y-1">
                                <label className="text-[16px] font-medium text-[#282829] font-medium">Time</label>
                                <div className="relative">
                                    <select className="w-full p-3 border border-[#E2E1E5] rounded-[12px] focus:outline-none focus:border-[#042C89] bg-white text-[#383A46] font-medium appearance-none">
                                        <option>Automatic entry</option>
                                    </select>
                ...
                <div className="xl:w-[30%]">
                    <div className="bg-[#363E49] rounded-[30px] overflow-hidden text-white shadow-lg flex flex-col p-7 h-fit">
                        {/* Header */}
                        <div
                            style={{ backgroundImage: "url('/assets/Frame.png')" }}
                            className="bg-cover bg-center px-6 rounded-[20px] py-4 flex justify-between items-center relative overflow-hidden"
                        >
                            {/* Decorative curve (optional, simple SVG or CSS) */}

                            <div className="flex flex-col">
                                <h3 className="text-black font-bold text-[20px] leading-tight">Account Status</h3>
                                <span className="text-black/80 text-[16px] text-[#282829] font-semibold">Active</span>
                            </div>
                        </div>
                        ...
                        <div className="py-6 pb-2 space-y-5">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 className="text-[24px] font-bold leading-tight">Account Holder</h4>
                                    <p className=" text-[16px] text-[#BDC0C3] font-medium">John Doe / Father</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 text-[16px]">
                                ...
                                <div className="border-b border-[#495362] pb-2">
                                    <p className="text-white text-[20px] font-medium mb-1">Venue</p>
                                ...
                                <div className="border-b border-[#495362] pb-3">
                                    <div className="flex justify-between items-end mb-1">
                                        <p className="text-white text-[20px]  font-bold">Progress</p>
                                    </div>
                                    <p className="text-[16px] font-semibold text-[#BDC0C3] mb-2">6 of 12 Months</p>
                            ...
                            <button
                                ...
                                className="w-full py-3 bg-[#237FEA] rounded-[12px] font-semibold text-white text-[18px] hover:bg-blue-600 transition-colors mt-2"
                            >
...
function DetailRow({ label, value }) {
    return (
        <div className="border-b border-[#495362] pb-3">
            <p className="text-white text-[20px] font-bold mb-0.5">{label}</p>
            <p className="font-semibold text-[#BDC0C3] text-[16px]">{value}</p>
        </div>
    );
}
