                ...
                {flowStep !== "D" ? (
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8 items-start">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            {/* Card 2: Venue, Camps & Class schedules */}
                            <div className="bg-white rounded-[20px] p-6 border border-[#e2e8f0] shadow-sm hover:shadow-md transition-shadow duration-300">
                                <div className="flex items-center gap-2.5 mb-5">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-[16px] text-gray-900">Venue, Camp & class preferences</h3>
                                ...
                                <div className="border border-[#e2e8f0] rounded-[16px] bg-gray-50/30">
                                    {/* Venue Banner */}
                                    <div className="bg-[#2f5aa0] text-white px-5 rounded-tl-[16px] rounded-tr-[16px] py-4 flex items-center justify-between gap-3 flex-wrap">
                                        <div className="flex items-center gap-2.5 font-bold text-[14px]">
                                            <MapPin size={15} />
                                            {selectedVenue?.label || "Select a Holiday Venue…"}
                                        </div>
                                        <button
                                    ...
                                    {isChangingVenue && (
                                        <div className="border-b border-[#e2e8f0] px-5 py-4 bg-[#f8fafc]">
                                            <label className="block text-[13px] font-semibold mb-1.5 text-[#1f2733]">Holiday Venue</label>
                                            <Select
                                                styles={selectStyles(false)}
                                                options={venueOptions}
                                                value={venueOptions.find((o) => o.value === selectedVenue?.value) || null}
                                                placeholder={venueOptions.length ? "Select a venue…" : "No holiday venues available"}
                                    ...
                                    <div className="p-5 border-b border-gray-100 bg-white">
                                        ...
                                        />
                                        {errors.camps && <p className="text-[12px] text-[#e53e3e] mt-1.5 flex items-center gap-1"><Info size={12} />{errors.camps}</p>}
                                    </div>
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            <div>
                                                                <label className="block text-[12px] font-semibold text-gray-500 mb-1.5 uppercase tracking-wide">
                                                                    Choose Waitlist Class/Level
                                                                </label>
                                                                <Select
                                                                    styles={selectStyles(!!errors[`s${sIdx}_selectedClassId`])}
                                                                    options={classOptions}
                                                                    value={classOptions.find((o) => String(o.value) === String(s.selectedClassId)) || null}
                                                            ...
                                                            <div>
                                                                <label className="block text-[12px] font-semibold text-gray-500 mb-1.5 uppercase tracking-wide">
                                                                    Class Time (Automatic)
                                                                </label>
                                                                <input
                                                                    disabled
                                                                    readOnly
                                                                    className={`${inputClass(false)} bg-[#f8fafc] text-[#6b7685] cursor-not-allowed`}
                                                                    value={s.time}
                                                                    placeholder="Set from selected class"
                                                                />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <Select
                                                                ...
                                                                onChange={(option) => handleStudentField(sIdx, "gender", option?.value || "")}
                                                            />
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => handleParentField(index, "parentFirstName", e.target.value.replace(/[^A-Za-z\s]/g, ""))}
                                                    />
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => handleParentField(index, "parentLastName", e.target.value.replace(/[^A-Za-z\s]/g, ""))}
                                                    />
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => handleParentField(index, "parentEmail", e.target.value)}
                                                    />
                                                ...
                                                <div>
                                                    ...
                                                    <PhoneNumberInput
                                                        ...
                                                        onChange={(v) => handleParentField(index, "parentPhoneNumber", v)}
                                                ...
                                                <div>
                                                    ...
                                                    <Select
                                                        ...
                                                        onChange={(opt) => handleParentField(index, "relationToChild", opt?.value || "")}
                                                    />
                                                ...
                                                <div>
                                                    ...
                                                    <Select
                                                        ...
                                                        onChange={(opt) => handleParentField(index, "howDidYouHear", opt?.value || "")}
                                                    />
                                                ...
                                                <div className="md:col-span-2">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => handleParentField(index, "interestReason", e.target.value)}
                                                ...
                                                <div className="md:col-span-2">
                                                    ...
                                                    <textarea
                                                        ...
                                                        onChange={(e) => handleParentField(index, "interestReasonOther", e.target.value)}
                                                    />
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="bg-white rounded-[20px] p-6 border border-[#e2e8f0] shadow-sm hover:shadow-md transition-shadow duration-300">
                                <div className="flex items-center gap-2.5 mb-5 pb-3 border-b border-gray-100">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[12px] text-[#6b7685]">Required for student safety during holiday training</p>
                                    </div>
                                </div>
                        ...
                        <div className="lg:sticky lg:top-6 flex flex-col gap-5">
                            ...
                            <div className="bg-white rounded-[20px] p-6 border border-[#e2e8f0] shadow-sm">
                                ...
                                <div className="flex flex-col gap-4 mb-5">
                                    ...
                                    <div className="flex gap-3 items-start">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-[13px] font-bold text-gray-700 leading-tight">
                                                {selectedVenue?.label || "Not selected"}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {/* Camps */}
                                    <div className="flex gap-3 items-start">
                                        <Sparkles className="text-[#3b7df6] w-4 h-4 mt-0.5 shrink-0" />
                                        <div>
                                            <div className="text-[11px] font-bold uppercase text-gray-400 tracking-wider">Waitlisted camps</div>
                                            <div className="text-[13px] font-bold text-gray-700 leading-tight">
                                                {selectedCamps.length === 0 ? (
                                                    <span className="text-gray-400 italic">No camp selected</span>
                                                ) : (
                                                    campOptions
                                                        .filter((o) => selectedCamps.includes(o.value))
                                                        .map((o) => o.label)
                                                        .join(", ")
                                                )}
                                            </div>
                                ...
                                <div className="border-t border-gray-100 pt-4.5 mb-5">
                                    <div className="flex items-center justify-between text-gray-900">
                                        <span className="font-bold text-[14px]">Holiday Registration</span>
                                    </div>
                                </div>
                    ...
                    <div className="max-w-[580px] mx-auto bg-white rounded-[24px] border border-[#e2e8f0] p-8 shadow-sm text-center">
                        ...
                        <p className="text-gray-500 text-[14px] mb-6 max-w-[420px] mx-auto">
                            Awesome! {activeNames} ha{activeStudents.length > 1 ? "ve" : "s"} been successfully registered on the Holiday Camp waiting list.
                        </p>
                                ...
                                <div className="grid grid-cols-2 gap-x-5 gap-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            value={calcAge(newChildForm.dob)}
