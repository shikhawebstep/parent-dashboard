...
import { Search, ChevronDown, ChevronRight, FileText, Send, ArrowLeft } from 'lucide-react';
                    ...
                    <div className="bg-white rounded-[30px] p-8 shadow-sm "> {/* Overlap header visual */}
                        ...
                        <div className="mb-8 relative">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <button className="bg-[#237FEA] text-white px-4 py-2 rounded-[12px] text-[14px] font-semibold shadow-sm hover:bg-[#037ecc]">Add Parent</button>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className={`poppins flex items-center  ${inputClass(errors.phone)}`}>
