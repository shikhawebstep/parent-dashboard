                    ...
                    {flowStates.map((fs, i) => {
                        ...
                        return (
                            <React.Fragment key={fs}>
                                <div className={`flex items-center gap-2 text-[14px] font-semibold ${isActive ? "text-[#1f2733]" : "text-[#6b7685]"}`}>
                                    <span
                        ...
                        <div className=" mx-auto md:px-6 px-2 mt-4">
                            <div className="bg-[#fff4dd] border border-[#ffd98a] text-[#7a5210] rounded-[14px] px-5 py-3 flex items-center justify-center gap-3 flex-wrap text-[14px]">
                                ...
                                <div className="flex items-center gap-1.5 ml-1">
                                    ...
                                    <span className="text-[14px] text-[#9c7a3a] font-semibold ml-1 uppercase tracking-wide">Left</span>
                                </div>
                            </div>
                        </div>
                    );
                ...
                <div className="bg-white mt-6 rounded-[16px] shadow-[0_8px_30px_rgba(20,40,80,0.08)] p-4 md:p-8">
                    ...
                    {flowStep === "A" && (
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-2.5 mb-5 w-full max-w-md mx-auto sm:max-w-none">
                                <button className="w-full sm:w-auto font-semibold text-[14px] rounded-[30px] px-4 py-2.5 bg-[#eaf1fe] text-[#3b7df6] border border-[#eaf1fe]">Select an existing child</button>
                                <button onClick={handleAddStudents} className="w-full sm:w-auto font-semibold text-[14px] rounded-[30px] px-4 py-2.5 bg-white text-[#6b7685] border border-[#e7ebf1]">Add a new child</button>
                            </div>
                            ...
                            <div className="flex justify-center gap-4 flex-wrap mb-2">
                                {students.map((s, i) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <div
                                                className={`absolute top-3.5 right-3.5 w-[22px] h-[22px] rounded-full border-2 flex items-center justify-center text-white text-[14px] ${isSel ? "bg-[#3b7df6] border-[#3b7df6]" : "border-[#e7ebf1]"
                                                    }`}
                                            >
                                                {isSel && <Check size={13} />}
                                            </div>
                                            <div className="text-[#3b7df6] font-bold text-[14px] mb-3">{s.studentFirstName || `Child ${i + 1}`}</div>
                                            <div className="grid grid-cols-2 gap-y-3 gap-x-2">
                                                <div><div className="text-[14px] text-[#6b7685]">Date of birth</div><div className="text-[14px] font-semibold">{s.dateOfBirth || "-"}</div></div>
                                                <div><div className="text-[14px] text-[#6b7685]">Age</div><div className="text-[14px] font-semibold">{s.age || "-"}</div></div>
                                                <div><div className="text-[14px] text-[#6b7685]">Gender</div><div className="text-[14px] font-semibold">{s.gender || "-"}</div></div>
                                                <div><div className="text-[14px] text-[#6b7685]">Class</div><div className="text-[14px] font-semibold">{s.selectedClassData?.className || ""}</div></div>
                                            </div>
                                        </div>
                                    );
                                })}
                            ...
                            <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#e7ebf1] p-4 z-40 flex gap-3 w-full sm:relative sm:bottom-auto sm:left-auto sm:right-auto sm:bg-transparent sm:border-t-0 sm:p-0 sm:z-auto justify-center sm:mt-7 sm:w-auto">
                                <button onClick={() => navigate(-1)} className="sm:w-auto font-semibold text-[14px] rounded-[12px] md:px-8 py-3.5 border border-[#e7ebf1] text-[#1f2733] bg-white px-4">Cancel</button>
                                <button disabled={selectedStudentIds.length === 0} onClick={() => setFlowStep("B")} className="sm:w-auto font-semibold text-[14px] rounded-[12px] md:px-8 py-3.5 border border-[#3b7df6] text-white bg-[#3b7df6] disabled:opacity-50 hover:bg-[#2f6ae0] px-4">Next</button>
                            </div>
                        </div>
                    )}
                        ...
                        <div>
                            ...
                            <div className="mb-6">
                                <div style={{ background: "linear-gradient(120deg, #1e3a6e, #2f5aa0)" }} className="text-white px-5 py-4 rounded-t-[14px] flex items-center justify-between gap-3 flex-wrap">
                                    ...
                                    <button onClick={() => setIsChangingVenue(!isChangingVenue)} className="bg-white/15 border border-white/35 text-white rounded-[20px] px-3.5 py-1.5 text-[14px] font-semibold">Change venue</button>
                                </div>
                                {isChangingVenue && (
                            ...
                            {showStarterPack && (
                                <>
                                    <div className="text-[12px] font-bold uppercase tracking-[0.04em] text-[#6b7685] mb-3">Starter pack</div>
                                    <div className="grid md:grid-cols-[200px_1fr] gap-5 border border-[#e7ebf1] rounded-[14px] p-4 mb-3.5 items-center">
                                        ...
                                        <div>
                                            <h5 className="text-[14px] font-bold mb-2.5 text-[#1f2733]">Every membership includes the Samba starter pack:</h5>
                                            ...
                                            <div className="border border-[#e7ebf1] rounded-[14px] p-4 mb-4 relative overflow-hidden">
                                                ...
                                                <div>
                                                    ...
                                                    {isChecked && !isDiscountLoading && (
                                                        isApplied
                                                            ? <p className="text-[#21b573] text-[14px] mt-1.5 flex items-center gap-1"><Check size={12} /> {appliedDiscount?.message || "Discount applied!"}</p>
                                                            : <p className="text-[#e53e3e] text-[14px] mt-1.5">Invalid discount code</p>
                                                    )}
                                                </div>
                                            </div>
                                        );
                                            ...
                                            <div key={s._tmpId ?? idx} className={`border border-[#e7ebf1] rounded-[10px] p-3 mb-3 flex items-center justify-between gap-4 flex-wrap`}>
                                                <div>
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-[35px] h-[35px] rounded-full bg-[#eaf1fe] flex items-center justify-center font-bold text-[#3b7df6]">{(s.studentFirstName || "?")[0]}</div>
                                                        <div className="font-semibold text-[14px]">{s.studentFirstName} {s.studentLastName}

                                                            <div className="font-semibold text-gray-400 text-[10px]">Age: {s.age} . {s.selectedClassData?.className || "Class not selected"}</div>
                                                ...
                                                <div className="flex-1 min-w-[150px] max-w-[150px]">
                                                    <label htmlFor={`size-${s._tmpId}`} className="block text-[11px] uppercase font-semibold text-gray-500">
                                                        Kit Size
                                                    </label>
                                                    <Select
                            ...
                            {selectedVenue ? (
                                <>
                                    <div className="text-[12px] font-bold uppercase tracking-[0.04em] text-[#6b7685] mb-3 mt-5">Choose your membership plan</div>
                                            ...
                                            {paymentPlanOptions.map((plan, idx) => {
                                                ...
                                                return (
                                                    <div key={plan?.value ?? idx} onClick={() => setMembershipPlan(plan)} className={`border-[1.5px] rounded-[14px] p-4 cursor-pointer transition-all relative ${isSel ? "border-[#3b7df6] bg-[#f5f9ff] ring-4 ring-[#3b7df6]/10" : "border-[#e7ebf1] hover:border-[#bcd0f5]"}`}>
                                                        ...
                                                        <div className="text-[14px] font-bold my-0.5 mb-1.5">{plan.all?.title || "Plan"}</div>
                                                        <div className="text-[21px] font-bold text-[#1e3a6e]">£{plan.all?.price ?? 0}<small className="text-[14px] text-[#6b7685] font-medium"> / month</small></div>
                                                        {is12Month && (
                                                            <span className="inline-block mt-2 bg-[#e7f8f0] text-[#0e7a4d] text-[14px] font-bold px-2.5 py-1 rounded-[20px]">Save £60 / year</span>
                                                        )}
                                                    </div>
                                                );
                                            })}
                            ...
                            {membershipPlan && (
                                <>
                                    <div className="text-[14px] font-bold uppercase tracking-[0.04em] text-[#6b7685] mb-3 mt-5">Select your start date</div>
                                        ...
                                        return hasFutureDates ? (
                                            <div className="border border-[#e7ebf1] rounded-[14px] p-4 max-w-[360px] mb-6">
                                                <div className="flex items-center justify-between mb-3">
                                                    ...
                                                    <span className="font-bold text-[14px]">{currentDate.toLocaleString("default", { month: "long" })} {year}</span>
                                                    <button onClick={() => { const nd = new Date(currentDate); nd.setMonth(nd.getMonth() + 1); setCurrentDate(nd); }} className="border border-[#e7ebf1] bg-white rounded-full w-[30px] h-[30px] flex items-center justify-center text-[#6b7685] font-bold hover:bg-[#f4f6f9]">
                                                        <ChevronRight size={16} />
                                                    </button>
                                                </div>
                                                <div className="grid grid-cols-7 gap-1 text-center">
                                                    {["M", "T", "W", "T", "F", "S", "S"].map((d, i) => <div key={i} className="text-[14px] text-[#6b7685] font-semibold py-1">{d}</div>)}
                            ...
                            {selectedDate && (
                                <div className="bg-[#f7f9fc] border border-[#e7ebf1] rounded-[14px] p-4 md:p-5 mt-5">
                                    <h4 className="text-[12px] uppercase tracking-[0.04em] text-[#6b7685] font-semibold mb-3">Price breakdown</h4>
                                    ...
                                    <div className="flex justify-between items-center text-[11px] py-1  "><span className="text-[#6b7685]">{getProRataLabel()}</span><span className="font-semibold">£{(pricingBreakdown.finalProRataCost || 0).toFixed(2)}</span></div>
                                    <div className="h-[1px] bg-[#e7ebf1] my-2.5" />
                                    <div className="flex justify-between items-center text-[11px] font-bold pt-2"><span className="text-[#1f2733] font-bold">Due today</span><span className="text-[#1e3a6e] font-bold">£{(pricingBreakdown.totalAmountToday || 0).toFixed(2)}</span></div>
                        ...
                        <div>
                            ...
                            <div className="grid md:grid-cols-[1fr_1.1fr] gap-6">
                                ...
                                <div className="bg-[#f1f6ff] rounded-[14px] p-5">
                                    <h3 className="text-[#1e3a6e] text-[14px] mb-3.5 font-bold">Your membership</h3>
                                    ...
                                    <div className="flex justify-between text-[14px] font-bold text-[#1e3a6e] mt-3.5 border-t border-[#d4e0f5] pt-3"><span>Monthly from 1st</span><span>£{(pricingBreakdown.nextMonthPayment || 0).toFixed(2)}</span></div>
                                </div>

                                {/* Form */}
                                <div>
                                    <h3 className="text-[14px] mb-1 font-bold">Direct Debit details</h3>
                                    ...
                                    <div className="grid grid-cols-2 gap-3.5 mb-4">
                                        <div>
                                            <label className="block text-[14px] font-semibold mb-1.5">Sort code</label>
                                            ...
                                            <div className="text-[14px] text-[#6b7685] mt-1">6 digits, auto-formatted</div>
                                            {ddErrors.branch_code && <p className="text-[14px] text-[#e53e3e] mt-1">{ddErrors.branch_code}</p>}
                                        </div>
                                        <div>
                                            <label className="block text-[14px] font-semibold mb-1.5">Account number</label>
                                            ...
                                            <div className="text-[14px] text-[#6b7685] mt-1">8 digits</div>
                                            {ddErrors.account_number && <p className="text-[14px] text-[#e53e3e] mt-1">{ddErrors.account_number}</p>}
                                        </div>
                                    </div>

                                    <div>
                                        <label className={`flex items-start gap-2.5 text-[14px] cursor-pointer ${ddErrors.authorise ? "text-[#e53e3e]" : "text-[#6b7685]"}`}>
                                        ...
                                        {ddErrors.authorise && <p className="text-[14px] text-[#e53e3e] mt-1 ml-6">{ddErrors.authorise}</p>}
                                    </div>
                                </div>
                            </div>

                            <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#e7ebf1] p-4 z-40 flex gap-3 w-full sm:relative sm:bottom-auto sm:left-auto sm:right-auto sm:bg-transparent sm:border-t-0 sm:p-0 sm:z-auto justify-center sm:mt-7 sm:w-auto">
                                <button onClick={() => setFlowStep("B")} className="sm:w-auto font-semibold text-[14px] rounded-[12px] md:px-8 py-3.5 border border-[#e7ebf1] text-[#1f2733] bg-white px-4">Back</button>
                                <button onClick={handleDDContinue} disabled={!isDDValid} className="sm:w-auto font-semibold text-[14px] rounded-[12px] md:px-8 py-3.5 border border-[#3b7df6] text-white bg-[#3b7df6] disabled:opacity-50 hover:bg-[#2f6ae0] px-4">
                    ...
                    {flowStep === "E" && (
                        <div>
                            ...
                            <div className="grid md:grid-cols-[1fr_1.1fr] gap-6">
                                {/* Summary */}
                                <div className="bg-[#f1f6ff] rounded-[14px] p-5">
                                    <h3 className="text-[#1e3a6e] text-[14px] mb-3.5 font-bold">Due today</h3>
                                ...
                                <div>
                                    ...
                                    <p className="text-[14px] text-[#6b7685] mb-4">This one-off payment covers your starter pack and delivery.</p>

                                    <div className="mb-4">
                                        <label className="block text-[14px] font-semibold mb-1.5">Card number</label>
                                        <div className="relative">
                                            ...
                                            {(payment.cardNumber || "").startsWith("4") && (
                                                <span className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[14px] font-bold text-[#1a1f71] bg-[#e8eaf6] px-2 py-0.5 rounded">VISA</span>
                                            )}
                                            {((payment.cardNumber || "").startsWith("5") || (payment.cardNumber || "").startsWith("2")) && (
                                                <span className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[14px] font-bold text-[#eb001b] bg-[#fce4ec] px-2 py-0.5 rounded">MC</span>
                                            )}
                                        </div>
                                        {cardErrors.cardNumber
                                            ? <p className="text-[14px] text-[#e53e3e] mt-1">{cardErrors.cardNumber}</p>
                                            : payment.cardNumber && isValidCardNumber(payment.cardNumber)
                                                ? <p className="text-[14px] text-[#21b573] mt-1 flex items-center gap-1"><Check size={12} /> Valid card number</p>
                                                : <div className="text-[14px] text-[#6b7685] mt-1">{(payment.cardNumber || "").replace(/\s/g, "").length}/16 digits</div>
                                        }
                                    </div>

                                    <div className="grid grid-cols-2 gap-3.5 mb-4">
                                        <div>
                                            <label className="block text-[14px] font-semibold mb-1.5">Expiry date</label>
                                            ...
                                            {cardErrors.expiryDate
                                                ? <p className="text-[14px] text-[#e53e3e] mt-1">{cardErrors.expiryDate}</p>
                                                : payment.expiryDate && isValidExpiry(payment.expiryDate)
                                                    ? <p className="text-[14px] text-[#21b573] mt-1"><Check size={12} /></p>
                                                    : null
                                            }
                                        </div>
                                        <div>
                                            <label className="block text-[14px] font-semibold mb-1.5">CVC</label>
                                            ...
                                            {cardErrors.cvc
                                                ? <p className="text-[14px] text-[#e53e3e] mt-1">{cardErrors.cvc}</p>
                                                : <div className="text-[14px] text-[#6b7685] mt-1">3–4 digits on back</div>
                                            }
                                        </div>
                                    </div>

                                    <div className="mb-4">
                                        <label className="block text-[14px] font-semibold mb-1.5">Name on card</label>
                                        ...
                                        {cardErrors.nameOnCard && <p className="text-[14px] text-[#e53e3e] mt-1">{cardErrors.nameOnCard}</p>}
                                    </div>

                                    <div className="grid grid-cols-2 gap-3.5">
                                        <div>
                                            <label className="block text-[14px] font-semibold mb-1.5">Country</label>
                                            <Select
                                                styles={rsStyles(false)}
                                        ...
                                        <div>
                                            <label className="block text-[14px] font-semibold mb-1.5">Postcode / ZIP</label>
                                            <input
                                                className="w-full font-inherit text-[14px] border border-[#e7ebf1] rounded-[10px] px-3.5 py-3 focus:outline-none focus:ring-2 focus:ring-[#3b7df6]"
                            ...
                            <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#e7ebf1] p-4 z-40 flex gap-3 w-full sm:relative sm:bottom-auto sm:left-auto sm:right-auto sm:bg-transparent sm:border-t-0 sm:p-0 sm:z-auto justify-center sm:mt-7 sm:w-auto">
                                <button onClick={() => setFlowStep("C")} className="sm:w-auto font-semibold text-[14px] rounded-[12px] md:px-8 py-3.5 border border-[#e7ebf1] text-[#1f2733] bg-white px-4">Back</button>
                                <button
                    ...
                    {flowStep === "D" && (
                        <div>
                            ...
                            <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#e7ebf1] p-4 z-40 flex gap-3 w-full sm:relative sm:bottom-auto sm:left-auto sm:right-auto sm:bg-transparent sm:border-t-0 sm:p-0 sm:z-auto justify-center sm:mt-7 sm:w-auto">
                                <button onClick={() => navigate("/bookings")} className="sm:w-auto font-semibold text-[14px] rounded-[12px] px-11 py-3.5 border border-[#21b573] text-white bg-[#21b573] hover:bg-[#1a935d]">Finish</button>
                            </div>
                        </div>
                    )}
                </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center px-8 py-5 border-b border-gray-100">
                                <div>
                                    <span className="text-[14px] uppercase tracking-wider text-[#237FEA] font-bold">Size guides</span>
                            ...
                            <div className="p-8 space-y-6 overflow-y-auto">
                                ...
                                <div className="border-l-4 border-[#237FEA] pl-4 py-1">
                                    <h3 className="text-[14px] font-bold text-gray-900">How to measure?</h3>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center px-7 py-5 border-b border-gray-100">
                                <div>
                                    <span className="text-[14px] uppercase tracking-wider text-[#3b7df6] font-bold">New child</span>
                            ...
                            <div className="p-7 overflow-y-auto">
                                <div className="grid grid-cols-2 gap-x-5 gap-y-4">
                                    ...
                                    <div>
                                        ...
                                        />
                                        {newChildErrors.studentFirstName && <p className="text-[14px] text-[#e53e3e] mt-1">{newChildErrors.studentFirstName}</p>}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        />
                                        {newChildErrors.studentLastName && <p className="text-[14px] text-[#e53e3e] mt-1">{newChildErrors.studentLastName}</p>}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            maxLength={10}
                                        />
                                        {newChildErrors.dateOfBirth && <p className="text-[14px] text-[#e53e3e] mt-1">{newChildErrors.dateOfBirth}</p>}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        />
                                        {newChildErrors.gender && <p className="text-[14px] text-[#e53e3e] mt-1">{newChildErrors.gender}</p>}
                                    </div>
