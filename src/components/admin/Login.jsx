    ...
    <div className="w-full h-full bg-white flex items-center p-5 md:p-0">
      <div className="w-full flex flex-col items-center justify-center m-auto ">
        <div className="text-center w-full mb-8">
          <div className="text-5xl font-bold text-blue-700 max-w-[70px] m-auto"> <img src="/assets/sambaLogoBlue.png" alt="" className="w-full" /></div>
          <h2 className="lg:text-[51px] font-semibold mt-3">Welcome</h2>
        ...
        <form onSubmit={handleSubmit} className="lg:w-[55%]">
          ...
          <div className="mb-1">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-3 text-gray-500 text-[18px]"
              >
          ...
          <button
            type="submit"
            className="w-full bg-[#237FEA] text-white text-[18px] font-bold py-2.5 rounded-[14px] hover:bg-blue-700 transition"
          >
            Log In
          </button>
        </form>
