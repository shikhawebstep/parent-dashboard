...
const MobileMenu = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 lg:hidden transition-all duration-300 ${isOpen ? "pointer-events-auto visible" : "pointer-events-none invisible"}`}
    >
      {/* Backdrop */}
      <div
      ...
      >
        ...
        <div className="space-y-4 mb-8 mt-3">
          ...
          <button
            ...
            className="w-full bg-[#00A6E3] hover:bg-[#0095CC] text-white font-bold py-3 rounded-full"
          >
        ...
        <button
          ...
          className="flex items-center gap-2 font-semibold text-white/90 hover:text-white mt-auto"
        >
          <img
            src="/assets/logout-04.png"
            alt=""
